...
public class ZombieHealthIndicator : MonoBehaviour
{
    [SerializeField]
    ...
    private void Update()
    {
        if (zombieHealth > 0 && zombieName != null)
        {
            ...
            float totalHealth = (100 + 100 * (GetComponent<ZombiesKillCounter>().GetRound() / GetComponent<ZombiesKillCounter>().GetBloodMoon()));
